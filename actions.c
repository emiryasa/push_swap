...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/27 14:52:26 by eyasa             #+#    #+#             */
/*   Updated: 2024/06/27 14:52:27 by eyasa            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (ft_strncmp(str, "sa", 3) == 0 || ft_strncmp(str, "sb", 3) == 0 || ft_strncmp(str, "ss", 3) == 0)
        swap(stacks, str);
    else if (ft_strncmp(str, "ra", 3) == 0 || ft_strncmp(str, "rb", 3) == 0 || ft_strncmp(str, "rr", 3) == 0)
        rotate(stacks, str);
    else if (ft_strncmp(str, "rra", 4) == 0 || ft_strncmp(str, "rrb", 4) == 0 || ft_strncmp(str, "rrr", 4) == 0)
        r_rotate(stacks, str);
